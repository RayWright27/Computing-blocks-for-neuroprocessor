//для коэффициентов нейронной сети
#define W_LEN_w 16//16 //полная длина числа в фиксированной точности 
#define I_LEN_w 2//2 //длина целой части числа в фикспоинт
//для значений изображения/карт признаков
#define W_LEN_i 16//20
#define I_LEN_i 5//6
//для вычисления внутри функции активации softmax  
//на финальном слое
#define W_LEN_s 40
#define I_LEN_s 18
